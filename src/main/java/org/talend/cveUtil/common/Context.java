...
public class Context {
    ...
    public static final String studio_in_one = git_repository+"studio";
...
//    public static final String tbd_studio_se = git_repository+"tbd-studio-se";
    public static final String tdi_studio_se_components = studio_in_one+"/common/main/plugins/org.talend.designer.components.localprovider/components/";
    public static final String tdi_studio_ee_components = studio_in_one+"/common/main/plugins/org.talend.designer.components.tisprovider/components/";
    public static final String tdi_studio_ee_components_sap = studio_in_one+"/common/main/plugins/org.talend.designer.components.tisprovider/components_dynamic/";
    public static final String tbd_studio_se_components = studio_in_one+"/bd/main/plugins/org.talend.designer.components.bigdata/components/";
